...
export const DatePickerInput = ({ onClick, localization, name, formattedValue, value, identifier, disabled, required, role, buttonRef, inputRef, onInput, onBlur, onFocus, }) => {
