...
const index = require('./index-ce0b4617.js');
...
const DatePickerInput = ({ onClick, localization, name, formattedValue, value, identifier, disabled, required, role, buttonRef, inputRef, onInput, onBlur, onFocus, }) => {
  return (index.h("div", { class: "duet-date__input-wrapper" },
    ...
    index.h("button", { class: "duet-date__toggle", onClick: onClick, disabled: disabled, ref: buttonRef, type: "button" },
      ...
      index.h("span", { class: "duet-date__vhidden" },
        ...
        formattedValue && (index.h("span", null,
          ", ",
...
const DatePickerDay = ({ focusedDay, today, day, onDaySelect, onKeyboardNavigation, focusedDayRef, inRange, dateFormatter, }) => {
  ...
  return (index.h("button", { class: {
    ...
    index.h("span", { class: "duet-date__vhidden" }, dateFormatter(day))));
};
...
const DatePickerMonth = ({ selectedDate, focusedDate, labelledById, localization, firstDayOfWeek, min, max, dateFormatter, onDateSelect, onKeyboardNavigation, focusedDayRef, onMouseDown, onFocusIn, }) => {
  ...
  return (index.h("table", { class: "duet-date__table", role: "grid", "aria-labelledby": labelledById, 
    ...
    index.h("tbody", null, chunk(days, 7).map(week => (index.h("tr", { class: "duet-date__row" }, week.map(day => (index.h("td", { class: "duet-date__cell", role: "gridcell", "aria-selected": isEqual(day, selectedDate) ? "true" : undefined },
      index.h(DatePickerDay, { day: day, today: today, focusedDay: focusedDate, inRange: inRange(day, min, max), onDaySelect: onDateSelect, dateFormatter: dateFormatter, onKeyboardNavigation: onKeyboardNavigation, focusedDayRef: focusedDayRef }))))))))));
};
